...
export default function OfflinePage({ onBack }) {
        ...
        return (
          <section className="card compare-card">
            ...
            <table className="assign-table">
              <thead>
                <tr><th>Metric</th><th>Min-Min</th><th>Max-Min</th></tr>
              </thead>
              <tbody>
                <tr>
                  <td>Makespan</td>
                ...
                <tr>
                  ...
                  <td colSpan="2" style={{ textAlign: 'center' }}>
                    <strong>{mmBetter ? 'Min-Min' : 'Max-Min'}</strong> achieves lower makespan by{' '}
                    <strong>{Math.abs(results.mm.makespan - results.mx.makespan).toFixed(2)}</strong> units
                  </td>
                </tr>
              </tbody>
            </table>
